...
const Sidebar = ({ open, onClose, selectedMarker }) => {
  ...
  // Build dynamic menu items from selectedMarker.sections
    ...
    >
      ...
      <Box sx={{ overflow: 'auto', p: 2 }}>
        ...
        <Typography variant="body2" sx={{ mb: 2, color: '#666' }}>
          Coordinates: {selectedMarker.program_details.latitude.toFixed(4)},{' '}
          {selectedMarker.program_details.longitude.toFixed(4)}
        </Typography>
